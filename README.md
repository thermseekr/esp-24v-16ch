...
ESP-24V-16CH-V3 - TODO - Move power LED to 3,3V bus, delete 5V bus, lower USB 5V to 3,3V. Replace individual resistors for rpacks where applicable. Move from 2 to 4 layers board to further shrink the board.
